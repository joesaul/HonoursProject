...
public class Parking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView)findViewById(R.id.carparkslist);
    ...
    class Connection extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String host = "http://150.237.94.38:8081/parking.php";
            try{
        ...
        protected void onPostExecute(String result){
            try {
                ...
                if(success == 1){
                    JSONArray carparks = jsonResult.getJSONArray("available_car_parks");
                    for(int i =0; i < carparks.length(); i++){
                        JSONObject computer_science = carparks.getJSONObject(i);
                        String availablecarparks = computer_science.getString("available car parks");

                        String line =  availablecarparks ;
                        adapter.add(line);
                    }
