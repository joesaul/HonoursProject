...
public class Maths extends AppCompatActivity {
    ...
    class Connection extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String host = "http://150.237.94.38:8081/maths.php";
            try{
        ...
        protected void onPostExecute(String result){
            try {
                ...
                if(success == 1){
                    JSONArray maths = jsonResult.getJSONArray("maths");
                    for(int i =0; i < maths.length(); i++){
                        JSONObject maths_ = maths.getJSONObject(i);
                        int id = maths_.getInt("id");
                        String starttime = maths_.getString("Start Time");
                        String finishtime = maths_.getString("Finish Time");
                        String building = maths_.getString("Building");
                        String room = maths_.getString("Room");
                        String description = maths_.getString("Description");
